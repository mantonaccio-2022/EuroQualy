...
Programa responsável pela impressão de boletos do Banco DAYCOVAL, gravação do nosso numero na tabela SE1.
...
User Function BOLDAYCO(nNum,serie,cliente,loja,nopc)
	...
	Private cFilter    := ""
	Private Tamanho    := "M"
	Private titulo     := "Impressão do Boleto [Banco Daycoval] "
...
DV Conta		,"C",01,0,"MV_PAR22"
	*/
	...
	Define MsDialog oDBlDayco Title "Emissão de Boletos [Banco Daycoval]" From C(225),C(407) To C(657),C(1061) Pixel

	@ C(049),C(005) TO C(190),C(325) LABEL " Títulos Selecionados " Pixel Of oDBlDayco
...
Static Function MontaRel()
	...
	For it:= 1 To Len( aVetor )
		...
		aDadosBanco  := {"707-2",;			// [1]Numero do Banco
			...
			cDVDayco,;			// [5]Dígito da conta corrente
