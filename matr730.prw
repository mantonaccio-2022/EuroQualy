...
If	UPPER(cUserName)  $ "ADMINISTRADOR#ALESSANDRA.MONEA#THIAGO.MONEA#CAROLINE.MONEA#ROBSON.MORAES#EUNICE.GODOY"
...
Else
	MsgStop("Usuário sem permissão para utilizar o relatório. Se necessário favor solicitar acesso a Diretoria!")
EndIf
...
TRCell():New(oPreNota,"AITEM15",/*Tabela*/,"Impostos"					,PesqPict("SC6","C6_VALOR"		),TamSx3("C6_VALOR"		)[1],/*lPixel*/,{|| (aItemPed[nItem][13] * ( 0.0925 + (MaFisRet(nItem,"IT_ALIQICM")/100) ) )			})	//Adicionado Euroamerican - 21/02/2018
...
TRCell():New(oPreNota,"AITEM16",/*Tabela*/,"Custo Net"					,PesqPict("SC6","C6_VALOR"	),TamSx3("C6_VALOR"			)[1],/*lPixel*/,{|| aItemPed[nItem][20] 																})	//Adicionado Euroamerican - 21/02/2018
...
TRCell():New(oPreNota,"AITEM17",/*Tabela*/,"Commissão"					,PesqPict("SC6","C6_VALOR"		),TamSx3("C6_VALOR"		)[1],/*lPixel*/,{|| aItemPed[nItem][24] 																})	//Adicionado Euroamerican - 21/02/2018
TRCell():New(oPreNota,"AITEM18",/*Tabela*/,"Frete"						,PesqPict("SC6","C6_VALOR"		),TamSx3("C6_VALOR"		)[1],/*lPixel*/,{|| aItemPed[nItem][25] 																})	//Adicionado Euroamerican - 21/02/2018
TRCell():New(oPreNota,"AITEM19",/*Tabela*/,"Custo Fixo"					,PesqPict("SC6","C6_VALOR"		),TamSx3("C6_VALOR"		)[1],/*lPixel*/,{|| aItemPed[nItem][26] 																})	//Adicionado Euroamerican - 21/02/2018
TRCell():New(oPreNota,"AITEM20",/*Tabela*/,"Juros"						,PesqPict("SC6","C6_VALOR"		),TamSx3("C6_VALOR"		)[1],/*lPixel*/,{|| aItemPed[nItem][27] 																})	//Adicionado Euroamerican - 21/02/2018

TRCell():New(oPreNota,"AITEM23",/*Tabela*/,"Fator Ant"						,"@e 99.99"	 ,5,/*lPixel*/,{|| aItemPed[nItem][21] 																})	//Adicionado Euroamerican - 04/06/2018


//TRCell():New(oPreNota,"NULTLIB",/*Tabela*/,STR0065						,PesqPictQt("D2_QUANT",10	    ),TamSx3("D2_QUANT"		)[1],/*lPixel*/,{|| nUltLib 																			})	// "Ult.Fat."

//Adicionado Euroamerican 20/02/2018 - Início
TRCell():New(oPreNota,"AITEM21",/*Tabela*/,"Fator Real"					,"@e 99.99"	 ,5,/*lPixel*/,{|| aItemPed[nItem][13] / ( aItemPed[nItem][13] - ( aItemPed[nItem][22] - (aItemPed[nItem][13] * ( 0.0925 + (MaFisRet(nItem,"IT_ALIQICM")/100) ) ) )	)		})	// Fator Real Venda - Adicionado Euroamerican - 21/02/2018
TRCell():New(oPreNota,"AITEM22",/*Tabela*/,"Resultado"					,PesqPict("SC6","C6_VALOR"		),TamSx3("C6_VALOR"		)[1],/*lPixel*/,{|| aItemPed[nItem][22] - (aItemPed[nItem][13] * ( 0.0925 + (MaFisRet(nItem,"IT_ALIQICM")/100) ) )		})	// Resultado Venda - Adicionado Euroamerican - 21/02/2018
//Adicionado Euroamerican 20/02/2018 - Fim
...
//Adicionado Euroamerican 20/02/2018 - Início
,
SC6.C6_QTDVEN * SC6.C6_U_CTNET AS CUSTONET,
C6_U_FATOR,
SC6.C6_VALOR *
CASE WHEN SC5.C5_TRANSP = '000002' THEN 0
	ELSE 0.045 END AS FRETE,
SC6.C6_VALOR * E4_ZPRZMED * 0.000421 AS JUROS,
SC6.C6_VALOR * SC5.C5_COMIS1 / 100 AS COMISSAO,
SC6.C6_ZPRCXTB,
SC6.C6_VALOR * 0.155 AS CUSTOFIXO
//Adicionado Euroamerican 20/02/2018 - Fim

%Exp:cQryAd%
FROM %Table:SC5% SC5, %Table:SC6% SC6, %Table:SE4% SE4
WHERE
...
While !oReport:Cancel() .And. !((cAliasSC5)->(Eof())) .and. xFilial("SC5")==(cAliasSC5)->C5_FILIAL
	...
	While !oReport:Cancel() .And. !((cAliasSC6)->(Eof())) .And. xFilial("SC6")==(cAliasSC6)->C6_FILIAL .And.;
		...
		//Adicionado Euroamerican 28/02/2018 - Início
		nResultad	:= (cAliasSC6)->C6_VALOR - (cAliasSC6)->CUSTONET - (cAliasSC6)->COMISSAO - (cAliasSC6)->FRETE - (cAliasSC6)->CUSTOFIXO - (cAliasSC6)->JUROS //Falta tirar valor ref aos impostos, retirado no momento da impressão
		//Adicionado Euroamerican 28/02/2018 - Fim	
		...
		aadd(aItemPed,	{	(cAliasSC6)->C6_ITEM	,;
			...
			(cAliasSC6)->C6_QTDLIB					,;
			(cAliasSC6)->C6_QTDENT					,;
			(cAliasSC6)->CUSTONET					,;	//20 - Adicionado Euroamerican 20/02/2018
			(cAliasSC6)->C6_U_FATOR					,;	//21 - Adicionado Euroamerican 20/02/2018
			nResultad								,;	//22 - Adicionado Euroamerican 20/02/2018
			(cAliasSC6)->C6_ZPRCXTB					,;	//23 - Adicionado Euroamerican 20/02/2018
			(cAliasSC6)->COMISSAO					,;	//24 - Adicionado Euroamerican 20/02/2018
			(cAliasSC6)->FRETE						,;	//25 - Adicionado Euroamerican 20/02/2018
			(cAliasSC6)->CUSTOFIXO					,;	//26 - Adicionado Euroamerican 20/02/2018
			(cAliasSC6)->JUROS						,;	//27 - Adicionado Euroamerican 20/02/2018
			})							
